...
const selectAnswer = (e) => {
    ...
    const isCorrect = selectedBtn.dataset.correct === "true"; // value and datatype both should be equal
    if(isCorrect){
...
const showScore = () => {
    resetState();
    question_element.innerHTML = ` Your score is ${score} out of the ${questions.length}!`;
